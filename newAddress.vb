...
Public Class newAddress
    ...
    Private Sub Button24_Click(sender As Object, e As EventArgs) Handles Button24.Click
        ...
        Dim xml As String = "{" & Chr(34) & "secret" & Chr(34) & ":" & Chr(34) & seed & Chr(34) & "," & Chr(34) & "amount" & Chr(34) & ":" & "1" & "," & Chr(34) & "recipientId" & Chr(34) & ":" & Chr(34) & "TbJguFizu8TydG3AMaB8TsWS5qKtu1fGQX" & Chr(34) & "}"
